...
/******/ 		if ( ( mode & 4 ) && 'object' === typeof value && value && value.__esModule ) {
return value;
}
...
function _objectWithoutProperties( source, excluded ) {
 if ( null == source ) {
return {};
} var target = _objectWithoutPropertiesLoose( source, excluded ); var key, i; if ( Object.getOwnPropertySymbols ) {
 var sourceSymbolKeys = Object.getOwnPropertySymbols( source ); for ( i = 0; i < sourceSymbolKeys.length; i++ ) {
 key = sourceSymbolKeys[i]; if ( 0 <= excluded.indexOf( key ) ) {
continue;
...
function _objectWithoutPropertiesLoose( source, excluded ) {
 if ( null == source ) {
return {};
} var target = {}; var sourceKeys = Object.keys( source ); var key, i; for ( i = 0; i < sourceKeys.length; i++ ) {
 key = sourceKeys[i]; if ( 0 <= excluded.indexOf( key ) ) {
continue;
} target[key] = source[key];
} return target;
}
...
function _objectSpread( target ) {
 ...
 var source = null != arguments[i] ? arguments[i] : {}; var ownKeys = Object.keys( source ); if ( 'function' === typeof Object.getOwnPropertySymbols ) {
...
var TransparencyPlugin = function TransparencyPlugin( iro, pluginOptions ) {
  ...
  iro.Color.prototype.set = function( value ) {
    var isObject = 'object' === _typeof( value );
